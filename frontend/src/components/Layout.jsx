...
const Layout = ({ onLogout, user }) => {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <Sidebar user={user} tasks={tasks} className="fixed left-4 top-20" />
                            ...
                            <div className="space-y-2 sm:space-y-3">
                                {tasks.slice(0, 3).map((task) => (
                                    <div
                                        ...
                                        className="flex items-center justify-between p-2 sm:p-3 hover:bg-purple-50/70 rounded-lg transition-colors duration-200 border border-transparent hover:border-purple-100"
                                    >
                                        ...
                                        <span
                                            className={`px-2 py-1 text-xs rounded-full ml-2 ${task.completed
